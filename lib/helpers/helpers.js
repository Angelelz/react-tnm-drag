...
function animateAndRemoveClone(ms, ref) {
...
exports.animateAndRemoveClone = animateAndRemoveClone;
function draggingOver(dragState, workingRef, e, direction, dispatchDragState, setArray, array, internalRef, delayMS, animationSync, id, index) {
    ...
    if (dragState.isDragging &&
        ...
        animationSync.AnimationSync.Animate(dragState.sourceItem.index, realIndex, direction, delayMS);
    }
}
